...
interface PegawaiAbsensiCustomTableProps {
  mappedAbsensis: Absensi[] | [];
  jadwals: JadwalKerja[];
  absensiColumns: typeof PegawaiAbsensiColumns;
  setIsModalFilterOpen: () => void;
}
const PegawaiAbsensiCustomTable = ({
  mappedAbsensis,
  jadwals,
  absensiColumns,
  setIsModalFilterOpen,
}: PegawaiAbsensiCustomTableProps) => {
...
export default PegawaiAbsensiCustomTable;
