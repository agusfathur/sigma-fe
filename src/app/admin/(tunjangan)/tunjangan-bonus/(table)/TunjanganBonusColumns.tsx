...
import { TunjanganBonusActions } from "./TunjanganBonusActions";

export const TunjanganBonusColumns: ColumnDef<TunjanganBonus>[] = [
  {
    id: "no",
    header: ({ column }) => (
  ...
  },
  {
    ...
    cell: ({ row }) => <TunjanganBonusActions row={row} />,
  },
];
